...
class PCKZ_Settings {
	...
	public static function default_options() {
		return array(
			...
			'licensing_master_admin_ip_allowlist' => '',
			'licensing_rate_limit_enabled' => true,
			'licensing_rate_limit_window_sec' => 300,
			'licensing_rate_limit_requests_per_ip' => 180,
			'licensing_block_duplicate_uuid_domains' => false,
			'licensing_require_uuid_format' => false,
			'licensing_allow_legacy_download_query' => true,
			'licensing_update_verify_checksum' => true,
			'licensing_update_require_manifest' => false,
