	...
	public static function enqueue_creator( $product_id, $config ) {
		...
		wp_localize_script(
			...
			array(
				...
				'i18n'         => array(
					'addToCart'             => 'Vielen Dank – Ihr Artikel wurde in den Warenkorb gelegt.',
					'addingToCart'          => 'Wird verarbeitet…',
					'designSaved'           => 'Ihr Entwurf wurde gespeichert.',
					'saving'                => 'Ihr Entwurf wird gespeichert…',
					...
					'paymentRequired'       => 'Bitte schließen Sie die Zahlung ab, um die Bestellung abzuschließen.',
