...
<div class="wrap pckz-admin-wrap pckz-license-dashboard <?php echo $master_mode ? 'pckz-license-dashboard--master' : 'pckz-license-dashboard--client'; ?>">
	...
	<?php else : ?>
				...
				<table class="widefat striped">
					<thead>
						<tr>
							...
							<th><?php esc_html_e( 'Key', 'pckz-canonical-engine' ); ?></th>
							<th><?php esc_html_e( 'Status', 'pckz-canonical-engine' ); ?></th>
							<th><?php esc_html_e( 'Domains', 'pckz-canonical-engine' ); ?></th>
							<th><?php esc_html_e( 'Limits', 'pckz-canonical-engine' ); ?></th>
							<th><?php esc_html_e( 'Actions', 'pckz-canonical-engine' ); ?></th>
						</tr>
					</thead>
					<tbody>
						<?php if ( empty( $licenses ) ) : ?>
							<tr><td colspan="7"><?php esc_html_e( 'No licenses found.', 'pckz-canonical-engine' ); ?></td></tr>
						<?php else : ?>
							<?php foreach ( $licenses as $license_row ) : ?>
								<?php
								...
								?>
								<tr>
									<td><?php echo esc_html( (string) (int) $license_row['id'] ); ?></td>
									<td><?php echo esc_html( $license_row['label'] ? $license_row['label'] : __( '—', 'pckz-canonical-engine' ) ); ?></td>
									<td><code><?php echo esc_html( $license_row['license_key'] ?? '' ); ?></code></td>
									...
									<td><?php echo esc_html( implode( ', ', $license_domains ) ); ?></td>
									<td><?php echo esc_html( sprintf( __( 'Max %d installs', 'pckz-canonical-engine' ), (int) ( $license_row['max_installs'] ?? 1 ) ) ); ?></td>
									<td>
										<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" class="pckz-inline-form">
											...
											<input type="hidden" name="license_id" value="<?php echo esc_attr( (string) $license_row['id'] ); ?>">
											...
											<button type="submit" class="button button-small"><?php esc_html_e( 'Apply', 'pckz-canonical-engine' ); ?></button>
										</form>
									</td>
								</tr>
							<?php endforeach; ?>
		...
		<section class="pckz-license-card pckz-license-card--full">
			<h2><?php esc_html_e( 'Installation Monitoring', 'pckz-canonical-engine' ); ?></h2>
			<form method="get" class="pckz-license-filter">
				<input type="hidden" name="page" value="pckz-license-server">
				<input type="search" name="pckz_install_s" value="<?php echo esc_attr( sanitize_text_field( wp_unslash( $_GET['pckz_install_s'] ?? '' ) ) ); ?>" placeholder="<?php esc_attr_e( 'Search domain or UUID', 'pckz-canonical-engine' ); ?>">
				...
				<table class="widefat striped">
					<thead>
						<tr>
							...
							<th><?php esc_html_e( 'Status', 'pckz-canonical-engine' ); ?></th>
							<th><?php esc_html_e( 'Action', 'pckz-canonical-engine' ); ?></th>
						</tr>
					</thead>
					<tbody>
						<?php if ( empty( $installs ) ) : ?>
							<tr><td colspan="6"><?php esc_html_e( 'No installations found.', 'pckz-canonical-engine' ); ?></td></tr>
						<?php else : ?>
								...
								<tr>
									...
									<td>
										<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" class="pckz-inline-form">
											...
											<select name="new_status">
												<option value="active"><?php esc_html_e( 'Active', 'pckz-canonical-engine' ); ?></option>
												<option value="blocked"><?php esc_html_e( 'Block', 'pckz-canonical-engine' ); ?></option>
											</select>
											<button type="submit" class="button button-small"><?php esc_html_e( 'Apply', 'pckz-canonical-engine' ); ?></button>
										</form>
									</td>
		...
		<section class="pckz-license-card pckz-license-card--full">
			<h2><?php esc_html_e( 'Download Statistics', 'pckz-canonical-engine' ); ?></h2>
			<div class="pckz-license-table-wrap">
				<table class="widefat striped">
					<thead>
						<tr>
						...
						<?php else : ?>
							<?php foreach ( $downloads as $download ) : ?>
								<tr>
									...
									<td><?php echo esc_html( $download['domain'] ?? '' ); ?></td>
									<td><code><?php echo esc_html( $download['install_uuid'] ?? '' ); ?></code></td>
									<td><?php echo esc_html( $download['requested_version'] ?? '' ); ?></td>
									<td><code><?php echo esc_html( $download['package_url'] ?? '' ); ?></code></td>
								</tr>
							<?php endforeach; ?>
						<?php endif; ?>
					</tbody>
